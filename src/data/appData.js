...
export const medicineConfig = {
  ...
  stats: [
    { label: 'In Stock', value: '1,034', color: 'success.main' },
    { label: 'Low Stock', value: '34', color: 'warning.main' },
    { label: 'Expired', value: '11', color: 'error.main' },
    { label: 'Categories', value: '18', color: 'secondary.main' },
  ],
  rows: medicinesRows,
...
export const inventoryConfig = {
  ...
  stats: [
    { label: 'Warehouse Stock', value: '9,420', color: 'success.main' },
    { label: 'Low Stock', value: '34', color: 'warning.main' },
    { label: 'Out of Stock', value: '11', color: 'error.main' },
    { label: 'Expiring Soon', value: '27', color: 'info.main' },
  ],
  rows: inventoryRows,
  columns: [
...
export const purchasesConfig = {
  ...
  stats: [
    { label: 'Open Orders', value: '12', color: 'secondary.main' },
    { label: 'Approved', value: '48', color: 'success.main' },
    { label: 'Pending', value: '9', color: 'warning.main' },
    { label: 'Total Value', value: 'Rs. 8.4M', color: 'primary.main' },
  ],
  rows: purchasesRows,
  columns: [
...
export const supplierConfig = {
  ...
  stats: [
    { label: 'Active Suppliers', value: '18', color: 'success.main' },
    { label: 'Pending Payments', value: '07', color: 'warning.main' },
    { label: 'Top Supplier', value: 'MediCare', color: 'secondary.main' },
    { label: 'Orders This Month', value: '92', color: 'primary.main' },
  ],
  rows: supplierRows,
  columns: [
...
export const customerConfig = {
  ...
  stats: [
    { label: 'Registered Customers', value: '2,148', color: 'primary.main' },
    { label: 'Loyalty Members', value: '1,006', color: 'success.main' },
    { label: 'High Value', value: '120', color: 'secondary.main' },
    { label: 'New This Week', value: '36', color: 'warning.main' },
  ],
  rows: customerRows,
  columns: [
